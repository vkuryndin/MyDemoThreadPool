...
/**
 * This interface allows a Worker to communicate with the thread pool without depending directly on
 * the full pool implementation.
 *
 * <p>The pool will later implement this interface and provide answers about its current state.
 */
public interface WorkerController {
   ...
   *
   * <p>In this mode, workers should stop as soon as possible.
   *
   ...
   *
   * <p>Usually the pool will return true only if the current number of workers is greater than
   * corePoolSize.
   *
   ...
   *
   * <p>The pool may use this callback to remove the worker from internal collections.
   *
