 ...
 *
 * This task simulates real work by sleeping for a given amount of time.
 * It also prints readable log messages so that we can observe
 * how tasks are executed by different worker threads.
 */
public class DemoTask implements Runnable {
     ...
     *
     * The task logs its start, sleeps for the configured time,
     * and then logs completion.
     *
     * If the thread is interrupted, the task restores the interrupted flag
     ...
     *
     * This is important because the pool logs task objects directly.
     *
