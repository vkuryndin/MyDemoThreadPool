 ...
 *
 * <p>These tests verify: - validation of pool name - correct thread naming - uniqueness of
...
class CustomThreadFactoryTest {
  ...
  void shouldThrowWhenPoolNameIsNull() {
    assertThrows(IllegalArgumentException.class, () -> new CustomThreadFactory(null));
  }

  /** Verifies that the factory does not accept a blank pool name. */
  @Test
  void shouldThrowWhenPoolNameIsBlank() {
    assertThrows(IllegalArgumentException.class, () -> new CustomThreadFactory("   "));
  }
