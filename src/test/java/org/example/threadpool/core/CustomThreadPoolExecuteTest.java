 ...
 *
 * <p>These tests verify: - execute() really runs submitted Runnable tasks - multiple Runnable tasks
 * can be completed correctly
 */
class CustomThreadPoolExecuteTest {

  /**
   * Verifies that a single Runnable task submitted via execute() is actually executed by the pool.
   */
  @Test
  ...
  /** Verifies that multiple Runnable tasks submitted via execute() are all executed by the pool. */
  @Test
