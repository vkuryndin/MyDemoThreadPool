 ...
 *
 * <p>These tests verify: - submitted / accepted / completed counters for normal execution -
 * submitted / rejected counters for rejected tasks
 */
class CustomThreadPoolMetricsTest {

  /**
   * Verifies that the pool correctly tracks submitted, accepted, rejected, and completed tasks
  ...
  /** Verifies that the pool correctly tracks rejected tasks after shutdown has already started. */
  @Test
